                        ...
                        <form class="form-horizontal" method="post" action="/rentmanager/users/update">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="last_name" name="last_name" value="${client.nom}" required pattern=".{3,}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="naissance" name="naissance" value="${client.naissance}" required>
                                    </div>
                                </div>
